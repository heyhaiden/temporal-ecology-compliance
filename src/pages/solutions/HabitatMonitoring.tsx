      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img alt="StreamLine Smart Sensor" className="rounded-2xl shadow-lg" src="https://carbonrewild.com/wp-content/uploads/2022/03/Website-infographics-1080-%C3%97-1080px.png" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {sensorCapabilities.map((capability, index) => <div key={index} className="flex items-start gap-3">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {powerConnectivity.map((item, index) => <div key={index} className="flex items-start gap-3">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {physicalSpecs.map((spec, index) => <div key={index} className="flex items-start gap-3">
